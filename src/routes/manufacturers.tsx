...
export const Route = createFileRoute("/manufacturers")({
  head: () => ({
    meta: [
      { title: "Manufacturing & Distribution Accounting | SMG" },
      {
        name: "description",
        content:
    ...
    <div className="min-h-screen bg-white text-[#1c2d42] font-sans antialiased selection:bg-blue-100 selection:text-blue-900">
      ...
      <main>
        ...
        <SubpageHero
          ...
          description="Cost accounting, inventory valuation, and tax credit strategies for industrial manufacturers, consumer goods producers, and wholesale supply chain distributors."
            ...
            <div className="grid gap-12 lg:grid-cols-12 lg:gap-16 items-center">
              <div className="lg:col-span-7">
                <h2 className="font-serif-hero text-2xl sm:text-3xl font-bold text-[#142340]">
                  Mastering Plant Floor Margins
                </h2>
                <h3 className="mt-2 font-serif-hero text-3xl sm:text-4xl font-bold text-[#1e3a6d]">
                  Accurate Cost Accounting &amp; Inventory Intelligence
                </h3>
          ...
          <div className="mx-auto max-w-xl px-6 lg:px-8">
            <div className="text-center mb-10">
              ...
              <p className="mt-2 text-sm sm:text-base text-blue-200">
                Book a consultation with our manufacturing &amp; supply chain advisory team.
              </p>
            </div>
            ...
            {submitted ? (
              ...
              >
                ...
                <div>
                  <textarea
                    rows={4}
                    placeholder="Tell us about your production lines, facility locations, or ERP systems..."
