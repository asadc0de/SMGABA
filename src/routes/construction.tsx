...
export const Route = createFileRoute("/construction")({
  head: () => ({
    meta: [
      { title: "Construction Accounting & Contractor Advisory | SMG" },
      {
        name: "description",
        content:
    ...
    <div className="min-h-screen bg-white text-[#1c2d42] font-sans antialiased selection:bg-blue-100 selection:text-blue-900">
      ...
      <main>
        ...
        <SubpageHero
          ...
          description="Job costing, WIP reporting, AIA progress billing, and surety bonding advisory for general contractors, commercial builders, and trade subcontractors."
            ...
            <div className="grid gap-12 lg:grid-cols-12 lg:gap-16 items-center">
              <div className="lg:col-span-7">
                ...
                <h3 className="mt-2 font-serif-hero text-3xl sm:text-4xl font-bold text-[#1e3a6d]">
                  True Job Costing &amp; Bonding Support
                </h3>
          ...
          <div className="mx-auto max-w-xl px-6 lg:px-8">
            <div className="text-center mb-10">
              ...
              <p className="mt-2 text-sm sm:text-base text-blue-200">
                Book a consultation with our construction financial advisory team.
              </p>
            </div>
            ...
            {submitted ? (
              ...
              >
                ...
                <div>
                  <input
                    type="text"
                    placeholder="Company / Contracting Business Name"
                    className="h-12 w-full rounded-xl border border-white/20 bg-white/10 px-4 text-sm text-white placeholder:text-white/60 focus:border-white focus:bg-white/15 focus:outline-none transition"
                  />
                </div>
                <div>
                ...
                <div>
                  <textarea
                    rows={4}
                    placeholder="Tell us about your project volume, commercial/residential mix, or bonding goals..."
