...
export const Route = createFileRoute("/legal-professionals")({
  head: () => ({
    meta: [
      { title: "Legal Accounting & Law Firm Advisory | SMG" },
      {
        name: "description",
        content:
  ...
  component: LegalProfessionalsPage,
});
            ...
            <div className="grid gap-12 lg:grid-cols-12 lg:gap-16 items-center">
              <div className="lg:col-span-7">
                ...
                <h3 className="mt-2 font-serif-hero text-3xl sm:text-4xl font-bold text-[#1e3a6d]">
                  Audit-Ready IOLTA Trust Accounting &amp; Partner Equity
                </h3>
          ...
          <div className="mx-auto max-w-xl px-6 lg:px-8">
            <div className="text-center mb-10">
              <h2 className="font-serif-hero text-3xl sm:text-4xl lg:text-5xl font-bold text-white">
                Let's Talk Legal Practice
              </h2>
              <p className="mt-2 text-sm sm:text-base text-blue-200">
                Book a consultation with our law firm accounting team.
              </p>
            </div>
            ...
            {submitted ? (
              <div className="rounded-2xl border border-blue-400/30 bg-blue-500/10 p-8 text-center backdrop-blur-md">
                ...
                <p className="mt-2 text-sm text-blue-100">
                  Your law firm consultation request has been received. We will contact you shortly.
                </p>
              </div>
            ) : (
              <form
